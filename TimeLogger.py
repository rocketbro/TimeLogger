...
def initialize():
	...
	if confirmed:
		...
		print("You may press RETURN to skip any of the following questions. Any information entered will exist only in files local to the current directory.\n")
		...
		initial_hours = input("Enter a total number of hours to count down from, i.e., '40' for a work week: ")
